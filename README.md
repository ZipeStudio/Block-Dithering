...
- Fully configurable block list: **whitelist** and **blacklist** by `id`, `#tag` or `*wildcard*`
  - For example: `minecraft:glass`, `#minecraft:flowers`, `minecraft:*copper_grate*`
- In-game config screen (YACL) with sliders for fade distance, pixel size and minimum visibility
- Searchable block lists and instant apply — no reload or restart needed

![general settings](https://github.com/ZipeStudio/block-dithering/blob/master/assets/general_settings.png?raw=true)
![whitelist settings](https://github.com/ZipeStudio/block-dithering/blob/master/assets/whitelist_settings.png?raw=true)
![blacklist settings](https://github.com/ZipeStudio/block-dithering/blob/master/assets/blacklist_settings.png?raw=true)
...
The license terms for this project are defined in the [LICENSE](https://github.com/ZipeStudio/block-dithering/blob/master/LICENSE.md) file in the source repository. That file always takes precedence over any license shown anywhere else.

### [View the source code](https://github.com/ZipeStudio/block-dithering)